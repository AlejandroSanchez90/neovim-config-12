...
vim.api.nvim_create_autocmd("LspAttach", {
	...
	callback = function(event)
		...
		vim.keymap.set("n", "<leader>lr", "<cmd>lsp restart<CR>", { buffer = event.buf, desc = "[L]SP [R]estart" })
		vim.keymap.set("n", "<leader>li", "<cmd>checkhealth vim.lsp<CR>", { buffer = event.buf, desc = "[L]SP [I]nfo" })
